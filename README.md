...
![GitHub](https://img.shields.io/badge/github-valerius21/google--news--skill-blue)
![Python](https://img.shields.io/badge/Python-3.7+-blue.svg)
![License](https://img.shields.io/badge/License-MIT-green.svg)

## ✨ Features

- 🔍 **Flexible Search**: Query any topic with full URL encoding support
- 🌍 **Region Support**: Get localized news from any country (US, DE, GB, FR, etc.)
- 📊 **Customizable Results**: Control the number of articles returned
- 🚀 **Fast & Reliable**: Python3 implementation with proper error handling
- 📝 **Blogwatcher Ready**: Output includes RSS URL for continuous monitoring
...
|-----------|----------|---------|-------------|
| `query` | ✅ | - | Search term for Google News |
| `count` | ❌ | `5` | Number of results to display |
| `region` | ❌ | `US` | Country code (e.g., DE, GB, FR, JP) |
